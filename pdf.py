...
# Load Switzerland PDF and create index
swiss_pdf_path = os.path.join("data", "Switzerland.pdf")  
swiss_pdf = PDFReader().load_data(file=swiss_pdf_path)
swiss_index = get_index(swiss_pdf, "switzerland")
swiss_engine = swiss_index.as_query_engine()